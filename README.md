...
ROS 2 pacage template, to get started, use template by clicking on the Green button labeled [`Use this template`](https://github.com/AronSzabo2003/sza_i5e_teknos/generate) / [`Create new repository`](https://github.com/AronSzabo2003/sza_i5e_teknos/generate). 
...
- `sza_i5e_teknos` >> `cool_ros2_package` (the folder was already renamed after `Use this template`)
- `AronSzabo2003` >> `mycoolusername`
- find all `AronSzabo2003` strings and fill the blanks
